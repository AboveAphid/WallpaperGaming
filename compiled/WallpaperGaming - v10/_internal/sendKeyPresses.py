...
class InactiveWindowPresser():
    ...
    def pressUseWithWrite(self, hwnd, info) -> None:
        """
        press function however it is specifically made to be used with write function
        """
        vk_key, delay = info
    ...
    def press(self, key, delay=0.1) -> None:
        """
        A general use function that sends a v_key press to a specific window 
        """
    ...
    def hold(self, key, holdlength=3, delay=0.1) -> None:
        """
        Holds a specific key down on window
        """
    ...
    def write(self, keys:list, delay=0.1) -> None:
        """
        Writes out a list of v_key codes onto window
        """
        for vk_key in keys:
            print(vk_key)
